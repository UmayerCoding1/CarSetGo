...
const FreePlanDeatils = ({features}) => {
    ...
    const freePlanFeatures = [
        ...
        { name: "Booking Management", value: false },
        { name: "Test Drive Requests", value: false },
        { name: "AI Description Generator", value: "0" },
        { name: "Priority Support", value: false },
        { name: "Verified Seller Badge", value: false },
        { name: "Edit Post", value: false },
        { name: "Delete Post", value: true },
        { name: "Car Promotion", value: false },
        { name: "Unlimited Chat", value: false },
        { name: "Ad Credits For Post", value: false }
    ];
    ...
    const renderValue = (value) => {
        if (typeof value === 'boolean') {
            return value ? <Check size={16} className="text-emerald-600 inline" /> : <X size={16} className="text-red-600 inline" />;
        }
            ...
            <table className="w-full border-collapse">
                <thead>
                    <tr className="bg-gray-50">
                        <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600 border-b">Plan Features</th>
                        <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600 border-b">Free Plan</th>
                        <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600 border-b">Available Features</th>
                    </tr>
                </thead>
                <tbody>
...
export default FreePlanDeatils;