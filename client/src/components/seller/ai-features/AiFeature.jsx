      ...
      <div>
        <div className="flex  justify-between my-5 gap-4">
          <div className="w-1/3 border-r">
            <h3 className="text-sm font-semibold my-3">Plan Name: <span className="bg-yellow-400 px-2 py-1 rounded-md">{(planDetails?.name)}</span></h3>
          ...
          <div className="w-full">
             ...
             <div>
                ...
                {planDetails?.name === 'advanced' && <AdvancePlanDetails features={planDetails?.features}/>}
             </div>
          </div>
        </div>
      </div>
