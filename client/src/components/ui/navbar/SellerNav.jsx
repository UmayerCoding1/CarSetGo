  ...
  return (
    <div className="flex items-center gap-4">
      ...
      {user?.isPlanActive === false && (
        <Link
          to="/pricing"
          className={`flex items-center ${"bg-gray-300"} px-2 py-1 rounded-lg cursor-pointer`}
        >
          <Zap strokeWidth={1} size={18} className={`${"text-gray-600"} `} />
          <span className="font-card text-xs font-semibold ">
            Upgrade to Pro
          </span>
        </Link>
      )}
