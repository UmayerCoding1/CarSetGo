      ...
      <div className="p-3 lg:flex items-center justify-between ">
        ...
        >
          <input
            ...
            placeholder="Search form transaction Id"
        ...
        <div>
          <Link
            to={`record?currentMonth=${new Date().toISOString().slice(0, 7)} `}
            className="bg-black text-white p-2 rounded-lg font-medium text-sm"
          >
            All Request Record
          </Link>
        </div>
