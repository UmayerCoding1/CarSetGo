...
import { getAllUsers, getSingleUser, googleLogin, logdinUser, logout, updateUserRole, uploadAvatar, userLogin, userRegister } from '../controllers/auth.controller.js';
...
router.get('/user/:id',verifyUser,verifyAdmin,getSingleUser);
